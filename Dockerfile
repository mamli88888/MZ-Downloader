...
COPY --chown=appuser:appuser bot.py config.py downloader.py routing.py instagram_caption.py spotisaver.py youtube_search.py youtube_sites_gateway.py social_gateway.py apify_gateway.py apify_platforms.py users_db.py pixeldrain_upload.py mz_shazam_search.py youtube_subtitle.py instagram_profile.py feature_flags.py store.py token_alerts.py user_features.py ai_service.py perf.py media_size.py structured_logging.py ahm7_gateway.py yoinku_gatewayy.py ./
