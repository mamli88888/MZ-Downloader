...
| 📸 **پروفایل اینستاگرام (CreatorCrawl)** | نمایش عکس پروفایل، فالوور، پست و دانلود آخرین پست با API |
...
├── creatorcrawl.py           # پروفایل و آخرین پست اینستاگرام (CreatorCrawl API + چرخش کلید)
...
| `/profile <یوزرنیم>` | عکس پروفایل + فالوور/پست + دکمه دانلود آخرین پست |
